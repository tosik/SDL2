...
#define SDL_CreateTextureSpecifiedD3DFragmentShader SDL_CreateTextureSpecifiedD3DFragmentShader_REAL
...
#define SDL_RenderCopyWithValue SDL_RenderCopyWithValue_REAL
